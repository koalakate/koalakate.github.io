  ...
  return (
    <section className="relative py-[80px] lg:py-[140px] overflow-hidden text-center">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(255, 184, 0, 0.3) 0%, rgba(255, 184, 0, 0.05) 50%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      {/* Sphere — bottom center, half-cropped by overflow-hidden */}
      <div
        className="absolute bottom-[-340px] left-1/2 -translate-x-1/2 pointer-events-none"
        style={{ zIndex: 0 }}
        aria-hidden="true"
      >
        <AsciiSphere
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-[1]">
        ...
        <p className="text-[clamp(1.1rem,2.5vw,1.5rem)] font-medium text-neutral-500 leading-[1.5] tracking-[-0.01em] max-w-[440px] mx-auto mt-5">
          No commitment. No environment changes. See what you&apos;re working
          with.
        </p>
